...
--
-- Internals of `GHC.ExecustionStack` module
--
-- /Since: 4.11.0.0/
-----------------------------------------------------------------------------
...
--
-- printStack :: IO ()
-- printStack = currentStackFrames >>= (putStrLn . displayStackFrames)
--
...
--
displayStackFrames :: [StackFrame] -> String
displayStackFrames frames =
    "Stack trace (Haskell):\n" ++
